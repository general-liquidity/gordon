...
# Usage: irm https://raw.githubusercontent.com/general-liquidity/gordon/main/scripts/install.ps1 | iex
# Custom dir: $env:GORDON_INSTALL_DIR="$env:LOCALAPPDATA\\Programs\\Gordon"; irm https://raw.githubusercontent.com/general-liquidity/gordon/main/scripts/install.ps1 | iex
...
$Repo = if ($env:GORDON_DIST_REPO) { $env:GORDON_DIST_REPO } else { "general-liquidity/gordon" }
$BinaryName = "gordon"
