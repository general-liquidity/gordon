    ...
    return (
      <Box flexDirection="column" paddingX={1} paddingY={1}>
        ...
        <Box marginTop={1} flexDirection="column">
          <Text>
            Binary: <Text color="yellow">{detailTool.bin}</Text>
          </Text>
          ...
          <Text>
            Pricing: {detailTool.pricing}
            {detailTool.pricingNote ? ` — ${detailTool.pricingNote}` : ""}
          </Text>
          <Text>
            Native coverage:{" "}
            <Text color={COVERAGE_COLORS[detailTool.nativeCoverage] as any}>
              {COVERAGE_LABELS[detailTool.nativeCoverage]}
            </Text>
          </Text>
        ...
        {tools.map((tool, i) => {
          ...
          return (
            <Box key={tool.id}>
              ...
              <Text color={COVERAGE_COLORS[tool.nativeCoverage] as any}>
                {tool.nativeCoverage.padEnd(10)}
              </Text>
