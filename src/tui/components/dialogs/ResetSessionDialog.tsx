...
export function ResetSessionDialog({
  onConfirm,
  onCancel,
}: ResetSessionDialogProps): React.JSX.Element {
  useInput((input, key) => {
  ...
  return (
    <Box flexDirection="column" borderStyle="round" borderColor="yellow" paddingX={1} paddingY={1}>
      ...
      <Text dimColor>
        This clears the visible transcript, pending approvals, queued input, and turn summaries.
      </Text>
      <Text dimColor>
        The current session identity stays intact. Use /new-session for a fresh thread.
      </Text>
      <Box marginTop={1}>
