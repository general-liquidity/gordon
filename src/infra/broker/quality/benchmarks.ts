 ...
 * latency/reliability harness (it mocks REST endpoints). Currently empty — every
 * supported broker speaks REST.
 */
export const NON_REST_BENCHMARK_BROKERS = new Set<BrokerId>([]);
