...
- Pairs with [[agent-health]] (the queues this load draws from) and the risk-acknowledgement gate (which fights the cognitive-surrender failure mode from the other direction, forcing engagement rather than reducing load).
