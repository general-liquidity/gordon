---
name: dca-setup
description: Set up dollar-cost averaging — recurring buys with smart timing. When user says "DCA into X", "set up recurring buys", "accumulate gradually", "ladder in", or wants dollar-cost averaging
arguments: [symbol]
