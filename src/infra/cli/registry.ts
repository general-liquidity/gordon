...
export const CLI_REGISTRY: CLIEntry[] = [
  ...
  },
  {
    ...
    description: "Generic installer for AI-agent skill packs. Hub-agnostic — pulls SKILL.md files from any Git URL (binance-skills-hub, custom org repos, community packs) into the standard agent-skills directory so Gordon's skill-loader picks them up alongside its own. This is how Binance intends their Skills Hub to be consumed; we don't wrap it, we register the canonical installer.",
    npmPackage: "skills",
    bin: "skills",
    commands: [
      { command: "skills add <url>", description: "Install a skill pack from a Git URL", example: "npx skills add https://github.com/binance/binance-skills-hub" },
    ...
    nativeCoverage: "none",
    credentials: [],
    docsUrl: "https://github.com/fforres/skills",
    markets: ["agent-tooling"],
    hasMCP: false,
    pricing: "free",
    pricingNote: "Free, open-source. Skills installed via this tool inherit the underlying repo's license — Binance Skills Hub is MIT.",
  },
  {
    id: "binance-cli",
    name: "Binance CLI",
