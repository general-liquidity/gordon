...
} from "./providers/sec/sec-insider.ts";
...
export const DATA_SOURCE_REGISTRY: DataSourceInfo[] = [
  ...
  },
  {
    ...
    type: "enrichment",
    requiresApiKey: true,
    rateLimit: "per-provider",
    endpoint: "via LLM client",
  },
  {
    id: "alpha-vantage",
    name: "Alpha Vantage",
    type: "price",
    requiresApiKey: true,
    rateLimit: "25/day (free) or 75/min (paid)",
  ...
  {
    id: "sec-segments",
    name: "SEC XBRL Revenue Segments",
    type: "segments",
    requiresApiKey: false,
    rateLimit: "10/sec",
    endpoint: "data.sec.gov",
  ...
  {
    id: "stock-screener",
    name: "Fundamental Stock Screener",
    type: "screener",
    requiresApiKey: false,
    rateLimit: "via Yahoo Finance",
    endpoint: "query2.finance.yahoo.com",
  },
  {
    id: "x-search",
