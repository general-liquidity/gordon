...
const LEGACY_SLASH_COMMANDS: SlashCommandSeed[] = [
  ...
  },
  {
    name: "arm",
    aliases: ["auto"],
    description: "Set permissionMode='auto' — auto-execute trades without per-action approval",
    usage: "/arm",
    category: "trading",
    level: 2,
    action: "tool",
  ...
  },
  {
    name: "disarm",
    aliases: ["ask"],
    description: "Set permissionMode='ask' — require user approval for each trade (default)",
    usage: "/disarm",
    category: "trading",
    level: 2,
    action: "tool",
  ...
  {
    name: "strict",
    aliases: ["safe", "readonly"],
    description: "Set permissionMode='strict' — read-only, all trades blocked",
    usage: "/strict",
    category: "trading",
    level: 2,
    action: "tool",
