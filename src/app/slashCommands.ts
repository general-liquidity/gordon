...
const LEGACY_SLASH_COMMANDS: SlashCommandSeed[] = [
  ...
  },
  {
    ...
    description: "Switch active venue — live or sandbox/paper (e.g. /exchange coinbase-sandbox)",
    usage: "/exchange [exchange-id]",
    category: "account",
    level: 1,
    action: "tool",
    target: "switch_exchange",
    executionTime: "~1-3s",
    whenToUse: "Switch between live and sandbox/testnet venues. Run with no args to list all configured exchanges.",
  },
  {
    name: "exchange-paper",
    aliases: ["venue-paper", "sandbox"],
    description: "Switch to the first configured sandbox/testnet venue",
    usage: "/exchange-paper",
    category: "account",
    level: 1,
    action: "tool",
    target: "switch_exchange",
    whenToUse: "Quickly jump to your sandbox venue before enabling /paper mode",
  },
  {
    name: "exchange-live",
    aliases: ["venue-live"],
    description: "Switch back to the primary live venue",
    usage: "/exchange-live",
    category: "account",
    level: 1,
    action: "tool",
    target: "switch_exchange",
    whenToUse: "Return to live trading venue after a paper/sandbox session",
  },
  {
    name: "broker",
    aliases: ["brokers", "br"],
