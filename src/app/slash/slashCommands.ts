...
const LEGACY_SLASH_COMMANDS: SlashCommandSeed[] = [
  ...
  },
  {
    ...
    usage: "/configure [exchange|broker|chains|mcp|llm|preferences|advanced]",
    category: "system",
    level: 1,
    action: "menu",
    target: "configure",
  ...
  // Onchain data (read-only adapters; no chain execution venues)
  {
    name: "chains",
    aliases: ["networks", "onchain", "providers"],
