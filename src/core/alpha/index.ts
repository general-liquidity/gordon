...
export {
  ...
  type HalfLifeRegime,
  type HalfLifeAssessment,
  type CostFloorHorizonInput,
  type CostFloorHorizon,
  type BacktestValidityInput,
  type BacktestValidity,
  type AdoptionSensitivityPoint,
  type AdoptionSensitivity,
  type AdoptionSensitivityOptions,
  type SignalClass,
  type ExtinctionEvent,
  type ExtinctionCascade,
  type ExtinctionCascadeOptions,
  type FragilityEfficiencyPoint,
  type FragilityEfficiencyTradeoff,
