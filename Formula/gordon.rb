...
class Gordon < Formula
  ...
  version "0.9.0-friends.9"
  license "MIT"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/general-liquidity/gordon-dist/releases/download/v#{version}/gordon-darwin-arm64"
      sha256 "181f832fc55506f7830d8ddac6678e44996a542a7a064d87adc2be8d5ce21f73"
    else
      url "https://github.com/general-liquidity/gordon-dist/releases/download/v#{version}/gordon-darwin-x64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/general-liquidity/gordon-dist/releases/download/v#{version}/gordon-linux-arm64"
      sha256 "e3579f7b089e66937685e2222322f0786baf67d9ec066c2a99da122c53221430_LINUX_ARM64"
    else
      url "https://github.com/general-liquidity/gordon-dist/releases/download/v#{version}/gordon-linux-x64"
